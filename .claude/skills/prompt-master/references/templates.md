...
*Use for Claude Code, Devin, AutoGPT, and any AI that takes autonomous actions. Stop conditions are not optional.*
...
- **Sora / video**: Add camera movement, duration in seconds, and cut style.
...
*Use when the user pastes an existing prompt and wants to break it down, adapt it for a different tool, simplify it, or split it.*
